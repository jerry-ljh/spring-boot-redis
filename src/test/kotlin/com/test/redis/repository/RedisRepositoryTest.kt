...
class RedisRepositoryTest(
    ...
    @Test
    fun `zCard 집합에 속한 value 수를 반환한다 `() {
        // given
        val value1 = "test value1"
        val value2 = "test value2"
        val value3 = "test value3"
        ...
        redisRepository.zAdd(key, value1, score)
        redisRepository.zAdd(key, value2, score)
        redisRepository.zAdd(key, value3, score)
        // when & then
        redisRepository.zCard(key) shouldBe 3
    }
    ...
    @Test
    fun `zRangeByScore 집합에서 startScore 이상 endScore이하의 값을 출력한다`() {
        // given
        val value1 = "test value1"
        val value2 = "test value2"
        val value3 = "test value3"
        ...
        redisRepository.zAdd(key, value3, score = 0.3)
        // when
        val result = redisRepository.zRangeByScore(key, startScore = 0.1, endScore = 0.2)
        // then
